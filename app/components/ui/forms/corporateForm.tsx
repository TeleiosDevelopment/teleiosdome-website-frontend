...
export default function PrivateForm() {
    ...
    const handleSubmit = async (e: React.FormEvent) => {
        e.preventDefault();
        try {
            const response = await fetch(`${process.env.NEXT_PUBLIC_API_BASE_URL}/api/form/corporateEventInquiry`, {
                method: "POST",
                headers: {
            ...
            <div className="pb-12 mt-0">
              ...
              <span className="text-sm text-white uppercase tracking-wider">
                ...
                <h2 className="text-5xl font-bold text-white text-center mt-12">
                    Corporate Event Inquiry Form                        </h2>
                ...
                <div className="pb-10 flex flex-col items-center h-3/4" >
                    ...
                    <form onSubmit={handleSubmit} className="space-y-4 w-full max-w-lg mx-auto">
                        <div>
                            <label htmlFor="contact_person_name" className="sr-only">Contact Person Name</label>
                            <input
                                type="text"
                        ...
                        <div>
                            <label htmlFor="event_type" className="sr-only">Event Type</label>
                            <select
                                name="event_type"
                                id="event_type"
                                required
                        ...
                        <div className="flex justify-center">
                            ...
                            >
                                <span className="skew-x-12">Inquire About Corporate Events</span>
                            </button>
                        </div>
                    </form>
                    )}
